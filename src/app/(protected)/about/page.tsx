...
let Aboutpage = () => {
  ...
  return (
    <>
      <section className="w-full py-12 sm:py-16 md:py-24 lg:py-32 relative overflow-hidden z-0">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-20 sm:w-40 h-20 sm:h-40 rounded-full bg-[#E6B312]/30"></div>
          <div className="absolute bottom-10 right-10 w-40 sm:w-60 h-40 sm:h-60 rounded-full bg-[#27A49C]/20"></div>
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4 sm:space-y-6">
              ...
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-[#27A49C]">
                {t("ourStory")}
              </h1>
            ...
            <div className="relative mt-8 lg:mt-0">
              ...
              <img
                ...
                className="relative mx-auto aspect-square w-full max-w-[350px] sm:max-w-[450px] lg:max-w-[550px] overflow-hidden rounded-2xl object-cover object-center border-4 border-white shadow-lg"
              />
              <div className="absolute -bottom-4 -right-4 h-16 w-16 sm:h-24 sm:w-24 rounded-full bg-[#27A49C] flex items-center justify-center text-white font-bold">
                <div className="text-center">
                  <div className="text-xl sm:text-2xl">8+</div>
      ...
      <section className="w-full py-12 sm:py-16 md:py-24 lg:py-32 bg-white dark:bg-[black]">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="space-y-2 max-w-3xl">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-[#27A49C]">
                {t("ourMisson")}
              </h2>
              <p className="text-muted-foreground text-base sm:text-lg md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                {t("weBelieve")}
          ...
          <div className="mx-auto grid max-w-5xl items-center gap-6 py-8 sm:py-12 sm:grid-cols-2 lg:grid-cols-3 lg:gap-12">
            <Card className="border-0 shadow-lg bg-gradient-to-b from-white to-[#27A49C]/5 overflow-hidden">
              ...
              <CardContent className="pt-8 pb-8">
                <div className="mb-6 flex h-12 sm:h-16 w-12 sm:w-16 items-center justify-center rounded-full bg-[#E6B312]/10 mx-auto">
                  <Heart className="h-6 sm:h-8 w-6 sm:w-8 text-[#E6B312]" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-center text-[#27A49C] mb-3">
                  {t("support")}
                </h3>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-b from-white to-[#E6B312]/5 overflow-hidden">
              ...
              <CardContent className="pt-8 pb-8">
                <div className="mb-6 flex h-12 sm:h-16 w-12 sm:w-16 items-center justify-center rounded-full bg-[#27A49C]/10 mx-auto">
                  <ShoppingBag className="h-6 sm:h-8 w-6 sm:w-8 text-[#27A49C]" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-center text-[#E6B312] mb-3">
                  {t("QualityProducts")}
                </h3>
                <p className="text-muted-foreground text-center text-sm sm:text-base">
                  {t("everyItems")}
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-b from-white to-[#27A49C]/5 overflow-hidden sm:col-span-2 lg:col-span-1">
              <div className="h-2 bg-[#E6B312]"></div>
              <CardContent className="pt-8 pb-8">
                <div className="mb-6 flex h-12 sm:h-16 w-12 sm:w-16 items-center justify-center rounded-full bg-[#E6B312]/10 mx-auto">
                  <MapPin className="h-6 sm:h-8 w-6 sm:w-8 text-[#E6B312]" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-center text-[#27A49C] mb-3">
                  {t("globalComunity")}
                </h3>
      ...
      <section className="w-full py-16 md:py-24 lg:py-32 relative overflow-hidden z-0 bg-[oldlace] dark:bg-[black]">
        <div className="absolute inset-0 opacity-10">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="space-y-2 max-w-3xl">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-[#E6B312]">
                {t("meetOurTeam")}
              </h2>
            ...
            {[
              ...
              >
                ...
                <div className="space-y-1 text-center">
                  <h3 className="text-xl font-bold text-[#27A49C]">
                    {member.name}
                  </h3>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-8 md:gap-12 lg:gap-16 lg:grid-cols-2">
            <div className="space-y-4 sm:space-y-6 w-full max-w-xl">
              ...
              <p className="text-muted-foreground text-base sm:text-lg md:text-xl/relaxed">
                {t("atCraftMarket")}
              </p>
              <ul className="grid gap-6 sm:gap-8">
                <li className="flex flex-col sm:flex-row items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-[#27A49C] text-lg">
                      {t("auth")}
                    </h3>
            ...
            <div className="relative mt-8 lg:mt-0">
              ...
              <img
                ...
                className="relative w-full max-w-[300px] sm:max-w-[350px] lg:max-w-[550px] mx-auto aspect-square overflow-hidden rounded-2xl object-cover object-center border-4 border-white shadow-lg"
              />
              <div className="absolute -top-6 -left-6 w-16 h-16 sm:w-24 sm:h-24 rounded-full bg-[#E6B312] flex items-center justify-center text-white font-bold">
                <div className="text-center">
                  <div className="text-xl sm:text-2xl">100%</div>
                  <div className="text-[10px] sm:text-xs">{t("auth")}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto grid max-w-5xl gap-8 py-12 lg:grid-cols-2 lg:gap-12">
            <Card className="border-0 shadow-lg bg-white dark:bg-[black] dark:shadow-[0px_0px_10px_grey] overflow-hidden">
              ...
              <CardContent className="p-8">
                ...
                <p className="mb-6 italic text-lg">{t("hasTransformed")}</p>
            ...
            <Card className="border-0 shadow-lg bg-white dark:bg-[black] dark:shadow-[0px_0px_10px_grey] overflow-hidden">
              ...
              <CardContent className="p-8">
                ...
                <p className="mb-6 italic text-lg">{t("IloveShopping")}</p>
                <div className="flex items-center gap-4">
                  <img
      ...
      <section className="w-full py-16 md:py-24 lg:py-32 bg-gradient-to-r from-[#27A49C] to-[#27A49C]/90 text-white">
        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
          ...
          <div className="flex flex-col gap-3 min-[400px]:flex-row justify-center mt-6">
            <Button
              size="lg"
              className="rounded-full bg-white text-[#27A49C] hover:bg-white/90"
            >
              {t("startShoping")}
            </Button>
            <Button
